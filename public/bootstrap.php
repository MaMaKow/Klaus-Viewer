 ...
 */
/**
 * @var FILE_SYSTEM_APPLICATION_PATH The full path of the application root as determined by the position of the default.php
 */
define('FILE_SYSTEM_APPLICATION_PATH', __DIR__ . '/../');
/**
 * @var HTTP_SERVER_APPLICATION_PATH The relative path of the application root on the web server.
...
spl_autoload_register(function ($class_name) {
    $base_dir = FILE_SYSTEM_APPLICATION_PATH . '/src/php/classes/';
...
if (!file_exists(FILE_SYSTEM_APPLICATION_PATH . 'config/config.php')) {
    header("Location: " . HTTP_SERVER_APPLICATION_PATH . "src/php/pages/install_page_intro.php");
    die("The application does not seem to be installed. Please see the <a href='" . HTTP_SERVER_APPLICATION_PATH . "src/php/pages/install_page_intro.php'>installation page</a>!");
} else {
    $config = array();
     ...
     */
    require_once FILE_SYSTEM_APPLICATION_PATH . "config/config.php";
    /*
