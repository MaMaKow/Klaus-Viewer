...
abstract class Localization {
    ...
    public static function initialize_gettext($locale) {
        if (\KlausViewer\Utility\GeneralUtility::runningOnWindows()) {
            /*
...
//setlocale(LC_ALL, $locale);
        ...
        if (FALSE === bindtextdomain("messages", \FILE_SYSTEM_APPLICATION_PATH . "locale")) {
     ...
     */
    public static function standardizeLanguageCode($languageInput) {
