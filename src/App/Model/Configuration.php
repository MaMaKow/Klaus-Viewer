...
namespace KlausViewer\App\Model;
...
class Configuration {
    ...
    public function __construct() {
        if (null == self::$loadedConfig) {
            ...
            $config = array();
            require FILE_SYSTEM_APPLICATION_PATH . "/config/config.php";
    ...
    public static $List_of_configuration_parameters = array(
        ...
        'display_errors' => 0,
        'log_errors' => 1,
        'error_log' => FILE_SYSTEM_APPLICATION_PATH . 'error.log',
        'LC_TIME' => 'C',
    ...
    private function write_new_config_entry(string $key, $value): void {
        $configuration_file = FILE_SYSTEM_APPLICATION_PATH . 'config/config.php';
